				...
				<div class="post-wrapper">
					...
					<footer class="entry-meta">
						<?php
							...
							echo 'To see the original picture <a href="'.esc_url(wp_get_attachment_url()).'">click here</a>. To return to the album <a href="'.esc_url(get_permalink($post->post_parent )).'">click here</a>.';
